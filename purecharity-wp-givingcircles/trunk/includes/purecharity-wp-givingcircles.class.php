 ...
 */
class Purecharity_Wp_Givingcircles {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Purecharity_Wp_Givingcircles_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'purecharity-wp-givingcircles';
		$this->version = '1.0.0';
  ...
  static function activation_check() {
    if ( ! self::base_present() ) {
      ...
      wp_die(
      	__( 
	      	'Pure Charity Giving Circles requires Pure Charity Base to be installed and active!', 
  ...
  function check_version() {
    ...
    echo '<strong>' . esc_html__( 'Pure Charity Giving Circles requires Pure Charity Base plugin to be installed and active.', 'purecharity-wp-base' ) . '</strong>';
  }
	 ...
	 *
	 * - Purecharity_Wp_Givingcircles_Loader. Orchestrates the hooks of the plugin.
	 * - Purecharity_Wp_Givingcircles_i18n. Defines internationalization functionality.
	 * - Purecharity_Wp_Givingcircles_Admin. Defines all hooks for the dashboard.
	 * - Purecharity_Wp_Givingcircles_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		...
		$this->loader = new Purecharity_Wp_Givingcircles_Loader();
	 ...
	 *
	 * Uses the Purecharity_Wp_Givingcircles_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Purecharity_Wp_Givingcircles_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Purecharity_Wp_Givingcircles_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Purecharity_Wp_Givingcircles_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Purecharity_Wp_Givingcircles_Loader    Orchestrates the hooks of the plugin.
	 */
